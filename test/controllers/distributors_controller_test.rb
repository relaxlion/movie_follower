...
class DistributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distributor" do
    assert_difference('Distributor.count') do
      post distributors_url, params: { distributor: { country_id: @distributor.country_id, name: @distributor.name } }
    end
  ...
  test "should update distributor" do
    patch distributor_url(@distributor), params: { distributor: { country_id: @distributor.country_id, name: @distributor.name } }
